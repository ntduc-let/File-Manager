...
import com.ntduc.basemvvmarchitecture.databinding.ItemDocumentBinding
import com.skydoves.baserecyclerviewadapter.BaseViewHolder
import com.ntduc.basemvvmarchitecture.model.Document

class ItemDocumentViewHolder(view: View) : BaseViewHolder(view) {

    private lateinit var data: Document
    private val binding: ItemDocumentBinding by bindings()
